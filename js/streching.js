...
streching.map((actividad) => {
    const contenedor = document.getElementById("contenedor-streching");
...
const obtenerProducto = (id) => {
    return streching.find(actividad => actividad.id == id);
}
